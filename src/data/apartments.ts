...
export const APARTMENTS: Apartment[] = [
  ...
  // 송파구 / 강동구 재분류
  { id: 'songpa-parkdale2', name: '파크데일2단지', district: '송파구', size: '44평', basePrice: 14, tier: '14', naverComplexId: '102314' },
  { id: 'songpa-pungnap-donga', name: '풍납동 동아한가람', district: '송파구', size: '34평', basePrice: 15, tier: '14', naverComplexId: '643' },
  { id: 'songpa-samsung-gwangnaru', name: '삼성광나루', district: '강동구', size: '24평', basePrice: 14.3, tier: '16', naverComplexId: '3116' },
  { id: 'songpa-dunchon-misojieum', name: '둔촌신성미소지움', district: '강동구', size: '24평', basePrice: 13, tier: '14', naverComplexId: '1296' },
  { id: 'songpa-the-platinum', name: '송파더플래티넘', district: '송파구', size: '21평', basePrice: 12, tier: '14', naverComplexId: '147185' },
  ...
  { id: 'gangdong-seonsa-hyundai', name: '선사현대', district: '강동구', size: '24평', basePrice: 14, tier: '14', naverComplexId: '3118' },
  ...
  { id: 'dongdaemun-hwegyeong-zai', name: '휘경자이디센시아', district: '동대문구', size: '24평', basePrice: 9, tier: '12', naverComplexId: '157123' },
  ...
  { id: 'songpa-raemian-ellinity', name: '래미안엘리니티', district: '동대문구', size: '24평', basePrice: 15, tier: '16', naverComplexId: '133184' },
  ...
  { id: 'dongjak-raemian-sangdo3', name: '래미안상도3차', district: '동작구', size: '42평', basePrice: 16.5, tier: '20', naverComplexId: '9194' },
  ...
  { id: 'eunpyeong-hongeun-byuksan', name: '홍은벽산', district: '은평구', size: '34평', basePrice: 6.3, tier: '12', naverComplexId: '432' },
  ...
  // 동대문구
  { id: 'dongdaemun-raemian-lagrande', name: '래미안라그란데', district: '동대문구', size: '24평', basePrice: 14, tier: '14', naverComplexId: '163360' },
  ...
  { id: 'seongdong-hyundai-prime', name: '현대프라임', district: '성동구', size: '24평', basePrice: 16.45, tier: '20', naverComplexId: '84' },
  ...
  { id: 'yangcheon-mokdong-park-zai', name: '목동파크자이', district: '양천구', size: '34평', basePrice: 17.5, tier: '20', naverComplexId: '115706' },
  ...
  { id: 'dongjak-sangdo-thesharp1', name: '상도더샵1차', district: '동작구', size: '24평', basePrice: 16.2, tier: '20', naverComplexId: '22789' },
  ...
  { id: 'gangdong-seonsa-hyundai-31', name: '선사현대 31평', district: '강동구', size: '31평', basePrice: 14, tier: '14', naverComplexId: '3118' },
  ...
  // 강남구
  { id: 'gangnam-samik-daecheong', name: '삼익대청', district: '강남구', size: '17평', basePrice: 17.5, tier: '20', naverComplexId: '419' },
  ...
  // 양천구
  { id: 'yangcheon-mokdong1', name: '목동신시가지1단지', district: '양천구', size: '24평', basePrice: 20, tier: '20', naverComplexId: '652' },
  ...
  { id: 'songpa-raemian-pinetop', name: '래미안송파파인탑', district: '송파구', size: '35평', basePrice: 20, tier: '20', naverComplexId: '103139' },

  // 강동구
  { id: 'gangdong-olympic-foreon', name: '올림픽파크포레온', district: '강동구', size: '24평', basePrice: 24.7, tier: '28', naverComplexId: '155817' },
  ...
  { id: 'songpa-els', name: '잠실엘스', district: '송파구', size: '24평', basePrice: 27.95, tier: '28', naverComplexId: '22627' },
  { id: 'songpa-trizium', name: '트리지움', district: '송파구', size: '24평', basePrice: 25.95, tier: '28', naverComplexId: '19127' },
  ...
  { id: 'yeongdeungpo-yeouido-sibum', name: '여의도시범', district: '영등포구', size: '47평', basePrice: 25.8, tier: '28', naverComplexId: '749' },
  ...
  { id: 'gangdong-1e61zli', name: '천호중흥S-클래스', district: '강동구', size: '25평', basePrice: 14, tier: '14', naverComplexId: '141005' },
  ...
  { id: 'gwangjin-by20yv', name: '구의현대7단지', district: '광진구', size: '25평', basePrice: 13.9, tier: '14', naverComplexId: '83' },
  { id: 'gwangjin-1jb4s0p', name: '자양우성1차', district: '광진구', size: '21평', basePrice: 13.5, tier: '14', naverComplexId: '90' },
  { id: 'gwangjin-1jb4s2f', name: '자양우성3차', district: '광진구', size: '22평', basePrice: 15.5, tier: '16', naverComplexId: '93' },
  ...
  // 동대문구
  { id: 'dongdaemun-ntj7q3', name: '래미안전농퍼스트하이', district: '동대문구', size: '34평', basePrice: 11.9, tier: '12', naverComplexId: '26918' },
  ...
  { id: 'mapo-pr3v39', name: '염리삼성래미안', district: '마포구', size: '24평', basePrice: 16.5, tier: '20', naverComplexId: '3299' },
  ...
  { id: 'seongbuk-19qmysv', name: '장위자이레디언트', district: '성북구', size: '34평', basePrice: 12.8, tier: '14', naverComplexId: '160539' },
  ...
  { id: 'eunpyeong-15tlroj', name: '대조1구역(재개발)', district: '은평구', size: '25평', basePrice: 6.7, tier: '12', naverComplexId: '3818' },
  ...
  // 광진구
  { id: 'gwangjin-192x14a', name: '광장극동2차', district: '광진구', size: '24평', basePrice: 24, tier: '24', naverComplexId: '67' },
  { id: 'gwangjin-1qbk1ln', name: '광장현대3단지', district: '광진구', size: '25평', basePrice: 16.4, tier: '20', naverComplexId: '74' },
  ...
  { id: 'dongjak-ad2tqg', name: '흑석리버파크자이', district: '동작구', size: '25평', basePrice: 21, tier: '24', naverComplexId: '131685' },
  ...
  { id: 'seocho-1dvxwur', name: '방배동우성', district: '서초구', size: '25평', basePrice: 24.5, tier: '28', naverComplexId: '471' },
  { id: 'seocho-fhzq0e', name: '방배동유원아파트', district: '서초구', size: '24평', basePrice: 14.2, tier: '16', naverComplexId: '491' },
  ...
  { id: 'seongdong-uw2vr3', name: '옥수극동(리모델링추진)', district: '성동구', size: '24평', basePrice: 16.9, tier: '20', naverComplexId: '562' },
  ...
  { id: 'songpa-n0p3vv', name: '가락삼환(재건축)', district: '송파구', size: '24평', basePrice: 20.5, tier: '24', naverComplexId: '597' },
  ...
  // 영등포구
  { id: 'yeongdeungpo-1haw9d', name: '당산역삼성래미안4차', district: '영등포구', size: '24평', basePrice: 20.5, tier: '24', naverComplexId: '2981' },
  ...
  { id: 'yongsan-okcvmj', name: '풍전', district: '용산구', size: '22평', basePrice: 17, tier: '20', naverComplexId: '760' },
  ...
  { id: 'gangnam-nelug1', name: '도곡한신', district: '강남구', size: '31평', basePrice: 24.5, tier: '28', naverComplexId: '408' },
  ...
  // 동작구
  { id: 'dongjak-lg9wkf', name: '이수역푸르지오더프레티움', district: '동작구', size: '34평', basePrice: 17.89, tier: '20', naverComplexId: '127384' },
  ...
  { id: 'seocho-mr8qen', name: '방배14구역(롯데캐슬)', district: '서초구', size: '25평', basePrice: 30, tier: '32', naverComplexId: '104449' },
  ...
  // 용산구
  { id: 'yongsan-du1f78', name: '이촌대림', district: '용산구', size: '24평', basePrice: 18.5, tier: '20', naverComplexId: '762' },
  ...
  { id: 'gangnam-msiz35', name: '일원현대(래미안루체하임)', district: '강남구', size: '23평', basePrice: 29.9, tier: '32', naverComplexId: '113125' },
  ...
  // 송파구
  { id: 'songpa-s51jk', name: '리센츠', district: '송파구', size: '24평', basePrice: 16.5, tier: '20', naverComplexId: '22746' },
  ...
  // 영등포구
  { id: 'yeongdeungpo-566wqg', name: '시범아파트', district: '영등포구', size: '24평', basePrice: 25.8, tier: '28', naverComplexId: '749' },
  ...
  // 강남구
  { id: 'gangnam-xmmvj9', name: '개포주공6단지', district: '강남구', size: '23평', basePrice: 31.5, tier: '32', naverComplexId: '1303' },
  ...
  { id: 'gangnam-1axdgfy', name: '청담삼익(르엘청구)', district: '강남구', size: '25평', basePrice: 50.6, tier: '50', naverComplexId: '182057' },
  ...
  { id: 'seocho-53bdof', name: '서초구립서초무지개(서초그랑자이)', district: '서초구', size: '25평', basePrice: 32, tier: '32', naverComplexId: '126726' },
  ...
  // 강남구
  { id: 'gangnam-w2vpuk', name: '디에이치퍼스티어아이파크', district: '강남구', size: '34평', basePrice: 16, tier: '16', naverComplexId: '134062' },
  ...
  { id: 'seocho-1i1i35c', name: '신반포8차(메이플자이예정)', district: '서초구', size: '25평', basePrice: 33, tier: '50', naverComplexId: '168097' },
  ...
  { id: 'seocho-98qgq', name: '신반포2차(재건축)', district: '서초구', size: '30평', basePrice: 42, tier: '50', naverComplexId: '531' },
  ...
  // 강남구
  { id: 'gangnam-ngb1v0', name: '수서주공1단지', district: '강남구', size: '18평', basePrice: 15.1, tier: '16', naverComplexId: '827' },
  ...
  { id: 'gangbuk-1k3tr3w', name: '꿈의숲효성해링턴', district: '강북구', size: '25평', basePrice: 7.9, tier: '12', naverComplexId: '116048' },
  ...
  { id: 'gangseo-1gg8dpf', name: '방화6단지', district: '강서구', size: '20평', basePrice: 6.2, tier: '12', naverComplexId: '1022' },
  { id: 'gangseo-foqe2s', name: '방화동도시개발2단지', district: '강서구', size: '21평', basePrice: 7.5, tier: '12', naverComplexId: '23' },
  { id: 'gangseo-lchev7', name: '방화동청구아파트', district: '강서구', size: '24평', basePrice: 7, tier: '12', naverComplexId: '1026' },
  ...
  { id: 'gwangjin-h3zin8', name: '중곡', district: '광진구', size: '20평', basePrice: 5.3, tier: '12', naverComplexId: '1060' },
  { id: 'gwangjin-1055j1w', name: '중곡', district: '광진구', size: '20평', basePrice: 5.3, tier: '12', naverComplexId: '1060' },
  ...
  { id: 'guro-13jsafg', name: '구로신도림자이', district: '구로구', size: '24평', basePrice: 11, tier: '12', naverComplexId: '3353' },
  { id: 'guro-vs4reo', name: '구로주공1차', district: '구로구', size: '22평', basePrice: 9, tier: '12', naverComplexId: '183037' },
  ...
  { id: 'guro-17b71mc', name: '구로현대연예인', district: '구로구', size: '25평', basePrice: 5.3, tier: '12', naverComplexId: '147' },
  ...
  { id: 'geumcheon-1jmzohz', name: '남서울건영2차', district: '금천구', size: '22평', basePrice: 5.8, tier: '12', naverComplexId: '165' },
  { id: 'geumcheon-nhixn3', name: '독산한신', district: '금천구', size: '24평', basePrice: 5.5, tier: '12', naverComplexId: '162' },
  { id: 'geumcheon-1fzchga', name: '벽산5단지', district: '금천구', size: '24평', basePrice: 5.2, tier: '12', naverComplexId: '3359' },

  // 노원구
  { id: 'nowon-mlfp1s', name: '공릉비선', district: '노원구', size: '25평', basePrice: 6.8, tier: '12', naverComplexId: '1093' },
  { id: 'nowon-mliqr1', name: '공릉태강', district: '노원구', size: '25평', basePrice: 7.4, tier: '12', naverComplexId: '1094' },
  { id: 'nowon-1w0ff3x', name: '공릉풍림아이원', district: '노원구', size: '33평', basePrice: 9.2, tier: '12', naverComplexId: '3363' },
  { id: 'nowon-7icavs', name: '노원꿈에그린', district: '노원구', size: '24평', basePrice: 10.8, tier: '12', naverComplexId: '124506' },
  { id: 'nowon-v72agw', name: '노원센트럴푸르지오', district: '노원구', size: '24평', basePrice: 9.8, tier: '12', naverComplexId: '117873' },
  { id: 'nowon-p1g54m', name: '상계벽산', district: '노원구', size: '31평', basePrice: 7.8, tier: '12', naverComplexId: '184' },
  { id: 'nowon-p1g4mz', name: '상계보람', district: '노원구', size: '33평', basePrice: 9.3, tier: '12', naverComplexId: '186' },
  { id: 'nowon-1pxk5p0', name: '상계주공11단지', district: '노원구', size: '24평', basePrice: 7.5, tier: '12', naverComplexId: '196' },
  { id: 'nowon-1pxk7x3', name: '상계주공14단지', district: '노원구', size: '24평', basePrice: 6.8, tier: '12', naverComplexId: '199' },
  { id: 'nowon-1pxk9eh', name: '상계주공16단지', district: '노원구', size: '24평', basePrice: 6.5, tier: '12', naverComplexId: '201' },
  { id: 'nowon-1gfhral', name: '상계주공1단지', district: '노원구', size: '23평', basePrice: 6.9, tier: '12', naverComplexId: '202' },
  { id: 'nowon-1gfhv02', name: '상계주공6단지', district: '노원구', size: '24평', basePrice: 8.5, tier: '12', naverComplexId: '920' },
  { id: 'nowon-1gfhvqr', name: '상계주공7단지', district: '노원구', size: '24평', basePrice: 8.2, tier: '12', naverComplexId: '921' },
  ...
  { id: 'nowon-4a7oqp', name: '월계주공2단지', district: '노원구', size: '24평', basePrice: 5.65, tier: '12', naverComplexId: '227' },
  { id: 'nowon-1fx9qbl', name: '월계풍림아이원', district: '노원구', size: '33평', basePrice: 8.3, tier: '12', naverComplexId: '9873' },
  { id: 'nowon-q34de3', name: '중계그린', district: '노원구', size: '21평', basePrice: 6.3, tier: '12', naverComplexId: '240' },
  { id: 'nowon-1gy1f3p', name: '중계동삼성아파트', district: '노원구', size: '33평', basePrice: 10.5, tier: '12', naverComplexId: '1113' },
  { id: 'nowon-rekdzx', name: '중계무지개', district: '노원구', size: '25평', basePrice: 7.5, tier: '12', naverComplexId: '925' },
  { id: 'nowon-16kyzol', name: '중계본동삼성현대', district: '노원구', size: '24평', basePrice: 5.1, tier: '12', naverComplexId: '1113' },
  { id: 'nowon-1xifna6', name: '중계양지대림', district: '노원구', size: '25평', basePrice: 7.5, tier: '12', naverComplexId: '1108' },
  { id: 'nowon-wy9xfi', name: '중계주공2단지', district: '노원구', size: '18평', basePrice: 5.2, tier: '12', naverComplexId: '1109' },
  { id: 'nowon-wy9znl', name: '중계주공5단지', district: '노원구', size: '31평', basePrice: 11.2, tier: '12', naverComplexId: '245' },
  { id: 'nowon-117w015', name: '중계중앙하이츠', district: '노원구', size: '25평', basePrice: 8.2, tier: '12', naverComplexId: '927' },
  { id: 'nowon-rmxodh', name: '하계미성', district: '노원구', size: '22평', basePrice: 7.3, tier: '12', naverComplexId: '257' },
  { id: 'nowon-rmzmu7', name: '하계장미', district: '노원구', size: '25평', basePrice: 7.2, tier: '12', naverComplexId: '262' },
  { id: 'nowon-rn0erv', name: '하계청구', district: '노원구', size: '32평', basePrice: 9.8, tier: '12', naverComplexId: '3257' },
  { id: 'nowon-1vz4wa1', name: '하계현대우성', district: '노원구', size: '31평', basePrice: 9.5, tier: '12', naverComplexId: '261' },

  // 도봉구
  { id: 'dobong-1bixw1e', name: '방학신동아1차', district: '도봉구', size: '22평', basePrice: 2.83, tier: '12', naverComplexId: '274' },
  { id: 'dobong-o2vgja', name: '창동주공3단지', district: '도봉구', size: '24평', basePrice: 7.2, tier: '12', naverComplexId: '326' },

  // 동대문구
  { id: 'dongdaemun-et79ps', name: '답십리래미안엘파인', district: '동대문구', size: '25평', basePrice: 9.8, tier: '12', naverComplexId: '25118' },
  { id: 'dongdaemun-jucv80', name: '두산아파트', district: '동대문구', size: '25평', basePrice: 8.8, tier: '12', naverComplexId: '3034' },
  { id: 'dongdaemun-1yyfboc', name: '래미안엘파인', district: '동대문구', size: '33평', basePrice: 11.5, tier: '12', naverComplexId: '25118' },
  ...
  { id: 'dongdaemun-90tsts', name: '용두롯데캐슬리치', district: '동대문구', size: '24평', basePrice: 11.2, tier: '12', naverComplexId: '106788' },
  ...
  { id: 'dongdaemun-py0519', name: '이문삼익', district: '동대문구', size: '24평', basePrice: 6.8, tier: '12', naverComplexId: '1124' },
  ...
  { id: 'dongdaemun-1jh6l7z', name: '전농하우스토리', district: '동대문구', size: '24평', basePrice: 9.2, tier: '12', naverComplexId: '23711' },
  { id: 'dongdaemun-1pfpqug', name: '제기동역푸르지오', district: '동대문구', size: '34평', basePrice: 12, tier: '12' },
  { id: 'dongdaemun-14ahkhl', name: '휘경베스트빌현대', district: '동대문구', size: '24평', basePrice: 7.9, tier: '12', naverComplexId: '3000' },
  { id: 'dongdaemun-wa7l0r', name: '휘경주공1단지', district: '동대문구', size: '25평', basePrice: 8.5, tier: '12', naverComplexId: '3379' },
  { id: 'dongdaemun-1umywh5', name: '휘경파크자이', district: '동대문구', size: '25평', basePrice: 9, tier: '12', naverComplexId: '157123' },
  { id: 'dongdaemun-bbkyub', name: '휘경해모로', district: '동대문구', size: '24평', basePrice: 8.5, tier: '12', naverComplexId: '118948' },
  { id: 'dongdaemun-afhh3n', name: '휘경SK뷰', district: '동대문구', size: '34평', basePrice: 12, tier: '12', naverComplexId: '112482' },

  // 동작구
  { id: 'dongjak-1sgs0a8', name: '극동아파트', district: '동작구', size: '24평', basePrice: 10.2, tier: '12', naverComplexId: '374' },
  { id: 'dongjak-7m8z84', name: '노량진우성', district: '동작구', size: '25평', basePrice: 11.2, tier: '12', naverComplexId: '362' },
  { id: 'dongjak-62zue4', name: '노량진우성아파트', district: '동작구', size: '25평', basePrice: 9.8, tier: '12', naverComplexId: '362' },
  { id: 'dongjak-uwyxgo', name: '대방주공2단지', district: '동작구', size: '25평', basePrice: 9.2, tier: '12', naverComplexId: '7960' },
  ...
  { id: 'dongjak-1qd7ocw', name: '보라매파크빌', district: '동작구', size: '33평', basePrice: 11.5, tier: '12', naverComplexId: '8388' },
  { id: 'dongjak-d0edn6', name: '본동삼성래미안', district: '동작구', size: '24평', basePrice: 11.5, tier: '12', naverComplexId: '9311' },
  { id: 'dongjak-p21ca9', name: '사당자이', district: '동작구', size: '24평', basePrice: 10.8, tier: '12', naverComplexId: '1138' },
  { id: 'dongjak-1i8ak8q', name: '상도래미안3차', district: '동작구', size: '24평', basePrice: 16.5, tier: '20', naverComplexId: '9194' },
  { id: 'dongjak-7wa77l', name: '상도브라운스톤', district: '동작구', size: '24평', basePrice: 17, tier: '20', naverComplexId: '10129' },
  { id: 'dongjak-2tvmoj', name: '상도중앙하이츠빌', district: '동작구', size: '32평', basePrice: 11.8, tier: '12', naverComplexId: '8987' },
  { id: 'dongjak-6zaqy7', name: '상도현대아이파크', district: '동작구', size: '24평', basePrice: 11.5, tier: '12', naverComplexId: '8753' },

  // 마포구
  { id: 'mapo-1v6dvoj', name: '도화현대1차', district: '마포구', size: '22평', basePrice: 11.5, tier: '12', naverComplexId: '407' },
  { id: 'mapo-1mozqi9', name: '마포쌍용황금아파트', district: '마포구', size: '24평', basePrice: 11.8, tier: '12', naverComplexId: '1148' },
  ...
  { id: 'mapo-gnohqp', name: '상암월드컵파크3단지', district: '마포구', size: '25평', basePrice: 10.2, tier: '12', naverComplexId: '13941' },
  ...
  { id: 'mapo-1y4h6iy', name: '성산동대우', district: '마포구', size: '24평', basePrice: 9.5, tier: '12', naverComplexId: '410' },
  ...
  { id: 'mapo-1y4mtex', name: '성산동풍림', district: '마포구', size: '23평', basePrice: 8.2, tier: '12', naverComplexId: '412' },
  { id: 'mapo-18eulif', name: '성산동풍림아파트', district: '마포구', size: '23평', basePrice: 7.8, tier: '12', naverComplexId: '412' },
  { id: 'mapo-1y4n11y', name: '성산동현대', district: '마포구', size: '24평', basePrice: 8.8, tier: '12', naverComplexId: '3473' },
  ...
  { id: 'mapo-mj4ra7', name: '신공덕래미안1차', district: '마포구', size: '24평', basePrice: 11.8, tier: '12', naverComplexId: '2992' },
  { id: 'mapo-1wkxc2k', name: '신수세양청마루', district: '마포구', size: '25평', basePrice: 11.2, tier: '12', naverComplexId: '5618' },
  { id: 'mapo-q4chno', name: '중동현대', district: '마포구', size: '25평', basePrice: 8.8, tier: '12', naverComplexId: '3472' },
  { id: 'mapo-om6xu4', name: '창전삼성래미안', district: '마포구', size: '24평', basePrice: 11.5, tier: '12', naverComplexId: '846' },

  // 서대문구
  { id: 'seodaemun-niiakw', name: '가재울중앙하이츠', district: '서대문구', size: '25평', basePrice: 9.5, tier: '12', naverComplexId: '1158' },
  { id: 'seodaemun-1o90wtb', name: '남가좌삼성래미안', district: '서대문구', size: '25평', basePrice: 8.5, tier: '12', naverComplexId: '3479' },
  { id: 'seodaemun-gsq2sg', name: '독립문극동', district: '서대문구', size: '24평', basePrice: 10.5, tier: '12', naverComplexId: '941' },
  { id: 'seodaemun-no9ex8', name: '독립문파크빌', district: '서대문구', size: '33평', basePrice: 10.8, tier: '12', naverComplexId: '3492' },
  { id: 'seodaemun-1jwk1e', name: '무악재역푸르지오', district: '서대문구', size: '24평', basePrice: 9, tier: '12', naverComplexId: '110092' },
  ...
  { id: 'seodaemun-z7hmx3', name: '북가좌삼호아파트', district: '서대문구', size: '24평', basePrice: 8.8, tier: '12', naverComplexId: '425' },
  { id: 'seodaemun-gspaed', name: '북가좌신일해피트리', district: '서대문구', size: '24평', basePrice: 8.2, tier: '12', naverComplexId: '22812' },
  { id: 'seodaemun-1iv7470', name: '북가좌월드컵현대', district: '서대문구', size: '24평', basePrice: 8.5, tier: '12', naverComplexId: '3483' },
  { id: 'seodaemun-1h6ornt', name: '북가좌현대', district: '서대문구', size: '24평', basePrice: 7.9, tier: '12', naverComplexId: '3484' },
  { id: 'seodaemun-1md677a', name: '북한산더샵', district: '서대문구', size: '34평', basePrice: 11.8, tier: '12', naverComplexId: '110458' },
  { id: 'seodaemun-1ae1chp', name: '북한산두산위브', district: '서대문구', size: '23평', basePrice: 8.8, tier: '12', naverComplexId: '114735' },
  { id: 'seodaemun-pv96ij', name: '연희성원', district: '서대문구', size: '24평', basePrice: 7, tier: '12', naverComplexId: '3393' },
  { id: 'seodaemun-o4w62k', name: '연희파크푸르지오', district: '서대문구', size: '34평', basePrice: 12, tier: '12', naverComplexId: '114768' },
  { id: 'seodaemun-oemq0f', name: '인왕산현대', district: '서대문구', size: '24평', basePrice: 8.5, tier: '12', naverComplexId: '945' },
  { id: 'seodaemun-s8zj6x', name: '인왕산힐스테이트', district: '서대문구', size: '24평', basePrice: 8.3, tier: '12', naverComplexId: '945' },
  { id: 'seodaemun-18ew61k', name: '천연뜨란채', district: '서대문구', size: '24평', basePrice: 9.5, tier: '12', naverComplexId: '11567' },
  { id: 'seodaemun-1dpz1py', name: '현저현대(재건축 대기)', district: '서대문구', size: '24평', basePrice: 8.2, tier: '12' },
  { id: 'seodaemun-tp2q7y', name: '홍은풍림아이원', district: '서대문구', size: '24평', basePrice: 6.8, tier: '12', naverComplexId: '10914' },
  ...
  { id: 'seodaemun-8epiux', name: '홍제센트럴아이파크', district: '서대문구', size: '25평', basePrice: 11.5, tier: '12', naverComplexId: '112357' },
  { id: 'seodaemun-bm8arh', name: '홍제원현대', district: '서대문구', size: '24평', basePrice: 8.5, tier: '12', naverComplexId: '26841' },
  { id: 'seodaemun-rvd15a', name: '홍제청구', district: '서대문구', size: '24평', basePrice: 7.8, tier: '12', naverComplexId: '8047' },
  { id: 'seodaemun-rven38', name: '홍제한양', district: '서대문구', size: '24평', basePrice: 7.5, tier: '12', naverComplexId: '7961' },
  { id: 'seodaemun-rvenfv', name: '홍제현대', district: '서대문구', size: '24평', basePrice: 7.8, tier: '12', naverComplexId: '437' },
  ...
  { id: 'seodaemun-1uunwbu', name: 'DMC아이파크', district: '서대문구', size: '32평', basePrice: 10.5, tier: '12', naverComplexId: '26029' },
  ...
  { id: 'seodaemun-4402kh', name: 'DMC한양아파트', district: '서대문구', size: '24평', basePrice: 10.5, tier: '12', naverComplexId: '426' },
  ...
  { id: 'seongdong-o9ubyx', name: '마장현대', district: '성동구', size: '32평', basePrice: 11.2, tier: '12', naverComplexId: '877' },
  { id: 'seongdong-roo4lo', name: '행당대림', district: '성동구', size: '25평', basePrice: 11.2, tier: '12', naverComplexId: '950' },

  // 성북구
  { id: 'seongbuk-aimoj4', name: '길음뉴타운11단지(롯데캐슬)', district: '성북구', size: '25평', basePrice: 10.5, tier: '12', naverComplexId: '112474' },
  { id: 'seongbuk-1ceajo4', name: '길음뉴타운1단지(래미안)', district: '성북구', size: '24평', basePrice: 11, tier: '12', naverComplexId: '3422' },
  { id: 'seongbuk-kd2wrb', name: '길음뉴타운2단지(푸르지오)', district: '성북구', size: '24평', basePrice: 9.2, tier: '12', naverComplexId: '8082' },
  { id: 'seongbuk-1pi2xy0', name: '길음뉴타운3단지(푸르지오)', district: '성북구', size: '24평', basePrice: 8.3, tier: '12', naverComplexId: '100347' },
  { id: 'seongbuk-qfz8p3', name: '길음뉴타운4단지(e편한세상)', district: '성북구', size: '24평', basePrice: 8.8, tier: '12', naverComplexId: '8083' },
  { id: 'seongbuk-lmkbyo', name: '길음뉴타운5단지(래미안)', district: '성북구', size: '24평', basePrice: 9.8, tier: '12', naverComplexId: '17515' },
  { id: 'seongbuk-1eg6t0v', name: '길음뉴타운6단지(래미안)', district: '성북구', size: '24평', basePrice: 9.5, tier: '12', naverComplexId: '18212' },
  { id: 'seongbuk-u73f84', name: '길음뉴타운7단지(두산위브)', district: '성북구', size: '24평', basePrice: 10.2, tier: '12', naverComplexId: '26251' },
  { id: 'seongbuk-ni5sw1', name: '돈암삼성', district: '성북구', size: '33평', basePrice: 9.2, tier: '12', naverComplexId: '579' },
  { id: 'seongbuk-nth2cg', name: '돈암한신휴플러스', district: '성북구', size: '24평', basePrice: 8.2, tier: '12', naverComplexId: '3424' },
  { id: 'seongbuk-ilru8t', name: '동아에코빌', district: '성북구', size: '33평', basePrice: 8.8, tier: '12', naverComplexId: '3425' },
  { id: 'seongbuk-1w0skww', name: '래미안세레니티', district: '성북구', size: '34평', basePrice: 11.2, tier: '12', naverComplexId: '25827' },
  { id: 'seongbuk-p32otf', name: '석관두산', district: '성북구', size: '25평', basePrice: 8.5, tier: '12', naverComplexId: '1183' },
  { id: 'seongbuk-1vcoeit', name: '석관래미안', district: '성북구', size: '32평', basePrice: 9.5, tier: '12', naverComplexId: '25948' },
  { id: 'seongbuk-hftz33', name: '월곡래미안루나밸리', district: '성북구', size: '24평', basePrice: 8.8, tier: '12', naverComplexId: '22199' },
  ...
  { id: 'seongbuk-1xh0mff', name: '정릉경남아너스빌', district: '성북구', size: '24평', basePrice: 6.9, tier: '12', naverComplexId: '586' },
  { id: 'seongbuk-1oj0l0d', name: '정릉풍림아이원', district: '성북구', size: '24평', basePrice: 6.2, tier: '12', naverComplexId: '3426' },
  { id: 'seongbuk-2g18tk', name: '정릉힐스테이트', district: '성북구', size: '33평', basePrice: 8.5, tier: '12', naverComplexId: '11213' },
  { id: 'seongbuk-60jtbx', name: '정릉힐스테이트3차', district: '성북구', size: '33평', basePrice: 8.2, tier: '12', naverComplexId: '23779' },
  { id: 'seongbuk-fomkce', name: '정릉e편한세상', district: '성북구', size: '24평', basePrice: 7.3, tier: '12', naverComplexId: '8596' },
  ...
  { id: 'yangcheon-epqnfo', name: '목동현대아파트', district: '양천구', size: '23평', basePrice: 9.5, tier: '12', naverComplexId: '675' },
  ...
  { id: 'yangcheon-801hrl', name: '신안약수(재건축추진)', district: '양천구', size: '22평', basePrice: 6.65, tier: '12', naverComplexId: '3777' },
  { id: 'yangcheon-104ajn2', name: '신월동대방샤인힐', district: '양천구', size: '23평', basePrice: 5.8, tier: '12', naverComplexId: '9650' },
  { id: 'yangcheon-6g9u48', name: '신월동벽산', district: '양천구', size: '25평', basePrice: 5.8, tier: '12', naverComplexId: '100390' },
  { id: 'yangcheon-dh4m7d', name: '신월동벽산블루밍2단지', district: '양천구', size: '23평', basePrice: 6.8, tier: '12', naverComplexId: '8956' },
  { id: 'yangcheon-3fexs0', name: '신월동보람쉬움1', district: '양천구', size: '23평', basePrice: 5.5, tier: '12', naverComplexId: '10327' },
  { id: 'yangcheon-kal7fy', name: '신월동삼익플라주', district: '양천구', size: '24평', basePrice: 5.3, tier: '12', naverComplexId: '108593' },
  { id: 'yangcheon-k7pmka', name: '신월동삼정그린뷰', district: '양천구', size: '23평', basePrice: 5.2, tier: '12', naverComplexId: '12960' },
  { id: 'yangcheon-ijay2m', name: '신월동수명산그린시아', district: '양천구', size: '25평', basePrice: 6.2, tier: '12', naverComplexId: '108631' },
  { id: 'yangcheon-tnjv5m', name: '신월동수명산SK뷰', district: '양천구', size: '24평', basePrice: 6.2, tier: '12', naverComplexId: '26688' },
  { id: 'yangcheon-qc5pac', name: '신월동태헌(프라자)', district: '양천구', size: '22평', basePrice: 2.35, tier: '12', naverComplexId: '3780' },
  { id: 'yangcheon-pexcwp', name: '신월시영', district: '양천구', size: '22평', basePrice: 6.5, tier: '12', naverComplexId: '858' },
  { id: 'yangcheon-1wh0cdn', name: '신월시영(재건축)', district: '양천구', size: '22평', basePrice: 6.8, tier: '12', naverComplexId: '858' },
  { id: 'yangcheon-z0dls5', name: '신정네거리역해링턴', district: '양천구', size: '24평', basePrice: 11.2, tier: '12' },
  { id: 'yangcheon-1sfy821', name: '신정동동일하이빌', district: '양천구', size: '25평', basePrice: 8.8, tier: '12', naverComplexId: '17469' },
  { id: 'yangcheon-1qxhpjx', name: '신정두산위브', district: '양천구', size: '24평', basePrice: 6, tier: '12', naverComplexId: '3784' },
  { id: 'yangcheon-f4hnvx', name: '신정신트리4단지', district: '양천구', size: '20평', basePrice: 7.45, tier: '12', naverComplexId: '3444' },
  { id: 'yangcheon-1v3kzic', name: '신정현대5차', district: '양천구', size: '24평', basePrice: 8.5, tier: '12', naverComplexId: '441' },
  { id: 'yangcheon-1v3kzj7', name: '신정현대6차', district: '양천구', size: '24평', basePrice: 7.8, tier: '12', naverComplexId: '3783' },
  { id: 'yangcheon-1g61o4o', name: '양천롯데캐슬', district: '양천구', size: '23평', basePrice: 8.5, tier: '12', naverComplexId: '102039' },
  { id: 'yangcheon-1fujo8e', name: '양천벽산블루밍1단지', district: '양천구', size: '23평', basePrice: 6.5, tier: '12', naverComplexId: '22680' },

  // 영등포구
  { id: 'yeongdeungpo-sobi50', name: '당산효성타운', district: '영등포구', size: '25평', basePrice: 11.8, tier: '12', naverComplexId: '2984' },
  { id: 'yeongdeungpo-4my2z1', name: '대림현대3차', district: '영등포구', size: '24평', basePrice: 7.8, tier: '12', naverComplexId: '698' },
  { id: 'yeongdeungpo-1cv2yqt', name: '도림동아에코빌', district: '영등포구', size: '24평', basePrice: 8.5, tier: '12', naverComplexId: '1211' },
  ...
  { id: 'yeongdeungpo-19p4lj1', name: '문래역대우', district: '영등포구', size: '24평', basePrice: 5.97, tier: '12', naverComplexId: '12978' },
  ...
  { id: 'yeongdeungpo-z4oi40', name: '신길우성1차', district: '영등포구', size: '22평', basePrice: 7.8, tier: '12', naverComplexId: '720' },
  { id: 'yeongdeungpo-njzrp0', name: '신길우성1차(재건축)', district: '영등포구', size: '22평', basePrice: 10.6, tier: '12', naverComplexId: '720' },
  { id: 'yeongdeungpo-pbcegs', name: '신길자이', district: '영등포구', size: '24평', basePrice: 10.2, tier: '12', naverComplexId: '27465' },
  ...
  // 은평구
  { id: 'eunpyeong-mlii60', name: '갈현현대', district: '은평구', size: '25평', basePrice: 5.8, tier: '12', naverComplexId: '1231' },
  ...
  { id: 'eunpyeong-auiy8u', name: '녹번역센트레빌', district: '은평구', size: '33평', basePrice: 10.5, tier: '12', naverComplexId: '104927' },
  { id: 'eunpyeong-n6hl9n', name: '녹번현대', district: '은평구', size: '24평', basePrice: 6.8, tier: '12', naverComplexId: '779' },
  { id: 'eunpyeong-1u2wm6x', name: '녹번JR아파트', district: '은평구', size: '24평', basePrice: 8.2, tier: '12', naverComplexId: '8830' },
  { id: 'eunpyeong-du1f78', name: '녹번대림e편한세상아파트', district: '은평구', size: '25평', basePrice: 7.4, tier: '12', naverComplexId: '778' },
  { id: 'eunpyeong-vm4xq5', name: '백련산파크자이', district: '은평구', size: '25평', basePrice: 8.5, tier: '12', naverComplexId: '113021' },
  { id: 'eunpyeong-xl5k1f', name: '북한산래미안', district: '은평구', size: '33평', basePrice: 10.8, tier: '12', naverComplexId: '26427' },
  { id: 'eunpyeong-1ef01kl', name: '북한산푸르지오', district: '은평구', size: '24평', basePrice: 10.5, tier: '12', naverComplexId: '107610' },
  { id: 'eunpyeong-1xqnyfw', name: '북한산힐스테이트3차', district: '은평구', size: '24평', basePrice: 9.5, tier: '12', naverComplexId: '26191' },
  ...
  { id: 'eunpyeong-feclmw', name: '연신내빌리브에이센트', district: '은평구', size: '25평', basePrice: 9.76, tier: '12', naverComplexId: '157968' },
  { id: 'eunpyeong-1696azi', name: '연신내역대경아르체', district: '은평구', size: '22평', basePrice: 6.2, tier: '12', naverComplexId: '169377' },
  { id: 'eunpyeong-t0ddol', name: '은평뉴타운기자촌11단지', district: '은평구', size: '24평', basePrice: 7.5, tier: '12', naverComplexId: '108372' },
  ...
  { id: 'eunpyeong-13sbll', name: 'DMC청구', district: '은평구', size: '24평', basePrice: 6.5, tier: '12', naverComplexId: '8694' },
  ...
  { id: 'jongno-1iljs0e', name: '창신 이수 (브라운스톤)', district: '종로구', size: '32평', basePrice: 10.2, tier: '12', naverComplexId: '10188' },

  // 중구
  { id: 'junggu-19bbo8d', name: '남산롯데캐슬아이리스', district: '중구', size: '20평', basePrice: 11.5, tier: '12', naverComplexId: '101771' },
  { id: 'junggu-13mf92l', name: '롯데캐슬베네치아', district: '중구', size: '23평', basePrice: 9.8, tier: '12', naverComplexId: '24845' },
  { id: 'junggu-pc09u6', name: '신당삼성', district: '중구', size: '24평', basePrice: 10.5, tier: '12', naverComplexId: '1237' },
  { id: 'junggu-1jg8a2h', name: '신당푸르지오', district: '중구', size: '24평', basePrice: 10.5, tier: '12', naverComplexId: '13845' },

  // 중랑구
  { id: 'jungnang-mk2sxv', name: '건영2차', district: '중랑구', size: '25평', basePrice: 7.8, tier: '12', naverComplexId: '806' },
  { id: 'jungnang-4i7jzp', name: '망우금호어울림', district: '중랑구', size: '24평', basePrice: 7, tier: '12', naverComplexId: '18196' },
  { id: 'jungnang-oazoxd', name: '면목현대', district: '중랑구', size: '24평', basePrice: 7, tier: '12', naverComplexId: '803' },
  { id: 'jungnang-1bbg7xj', name: '사가정센트럴아이파크', district: '중랑구', size: '25평', basePrice: 10.5, tier: '12', naverComplexId: '119588' },
  { id: 'jungnang-p3xdsd', name: '상봉태영', district: '중랑구', size: '25평', basePrice: 7.8, tier: '12', naverComplexId: '3470' },
  { id: 'jungnang-1y9jeww', name: '상봉태영데시앙', district: '중랑구', size: '25평', basePrice: 8.2, tier: '12', naverComplexId: '3470' },
  { id: 'jungnang-9de8a8', name: '상봉프레미어스엠코', district: '중랑구', size: '25평', basePrice: 9.2, tier: '12', naverComplexId: '102480' },
  { id: 'jungnang-2xge2i', name: '신내6단지', district: '중랑구', size: '20평', basePrice: 5.8, tier: '12', naverComplexId: '820' },
  { id: 'jungnang-18p7pj1', name: '신내9단지(진흥)', district: '중랑구', size: '21평', basePrice: 5.8, tier: '12', naverComplexId: '817' },
  { id: 'jungnang-3ns4yh', name: '신내데시앙', district: '중랑구', size: '24평', basePrice: 7.8, tier: '12', naverComplexId: '100653' },
  { id: 'jungnang-il7cyy', name: '중화동미소지움', district: '중랑구', size: '24평', basePrice: 7.2, tier: '12' },
  { id: 'jungnang-q9ea3r', name: '중화한신', district: '중랑구', size: '25평', basePrice: 7.5, tier: '12', naverComplexId: '824' },
  { id: 'jungnang-1nnyky9', name: 'e편한세상화랑대', district: '중랑구', size: '23평', basePrice: 9.5, tier: '12', naverComplexId: '110153' },


  // ========== 2026-03-17 엑셀 추가 (39개) ==========
  { id: 'gangnam-p55il3', name: '삼성동롯데', district: '강남구', size: '미정', basePrice: 24.5, tier: '28', note: '투자분석가이드 | 청담·삼성 접근', naverComplexId: '428' },
  { id: 'gangdong-v7put4', name: '강일리버파크6단지', district: '강동구', size: '미정', basePrice: 13.5, tier: '14', note: '투자분석가이드 | 강일 생활권 대단지', naverComplexId: '27478' },
  { id: 'gangdong-jr6kdi', name: '고덕아남', district: '강동구', size: '미정', basePrice: 11.5, tier: '12', note: '투자분석가이드 | 리모델링 + 트리플 역세권', naverComplexId: '1156' },
  { id: 'gangbuk-r3so72', name: '꿈의숲대명루첸', district: '강북구', size: '미정', basePrice: 9.1, tier: '12', note: '프리미엄콘텐츠 | 꿈의숲 생활권', naverComplexId: '26344' },
  { id: 'gangseo-26nqzi', name: '마곡수명산파크6단지', district: '강서구', size: '미정', basePrice: 12.4, tier: '14', note: '투자분석가이드 | 마곡 생활권 + 가격경쟁력', naverComplexId: '25969' },
  { id: 'gangseo-1mv1uch', name: '염창동신동아', district: '강서구', size: '미정', basePrice: 11.3, tier: '12', note: '뉴스레터 | 준공업지역 + 재건축 가능성', naverComplexId: '37' },
  { id: 'gangseo-jvag0v', name: '장미아파트', district: '강서구', size: '미정', basePrice: 5.2, tier: '12', note: '투자분석가이드 | 방화뉴타운 수혜 기대', naverComplexId: '262' },
  { id: 'nowon-10byhx', name: '중계주공4단지', district: '노원구', size: '미정', basePrice: 4.5, tier: '12', note: '뉴스레터 | 재건축 + 동북선 기대', naverComplexId: '924' },
  { id: 'nowon-1y7tg51', name: '태릉해링턴', district: '노원구', size: '미정', basePrice: 9.4, tier: '12', note: '프리미엄콘텐츠 | 24평 언급', naverComplexId: '125162' },
  { id: 'dobong-zbpe8o', name: '창동현대2차', district: '도봉구', size: '미정', basePrice: 8.7, tier: '12', note: '투자분석가이드 | 창동역 생활권 + 최근 분석', naverComplexId: '2978' },
  { id: 'dongdaemun-1ri3hox', name: '전농동동아', district: '동대문구', size: '미정', basePrice: 9.5, tier: '12', note: '뉴스레터 | 청량리 개발 수혜 기대', naverComplexId: '1126' },
  { id: 'dongjak-3dyukn', name: '대방2단지주공', district: '동작구', size: '미정', basePrice: 12, tier: '12', note: '투자분석가이드 | 여의도 접근 + 교육환경', naverComplexId: '7960' },
  { id: 'dongjak-890s4m', name: '사당우성3단지', district: '동작구', size: '미정', basePrice: 13.5, tier: '14', note: '투자분석가이드 | 이수역 생활권 + 거주/투자 밸런스', naverComplexId: '381' },
  { id: 'mapo-3agc6o', name: '메세나폴리스', district: '마포구', size: '미정', basePrice: 23, tier: '24', note: '투자분석가이드 | 합정 핵심 + 상권 + 한강 접근', naverComplexId: '103831' },
  { id: 'mapo-r6i5n', name: '신촌숲아이파크', district: '마포구', size: '미정', basePrice: 21.3, tier: '24', note: '투자분석가이드 | 신축 대단지 + 실거주/투자 수요', naverComplexId: '114335' },
  { id: 'seodaemun-17epo2c', name: '동부센트레빌', district: '서대문구', size: '미정', basePrice: 10.1, tier: '12', note: '투자분석가이드 | 냉천동 도심 접근', naverComplexId: '3421' },
  { id: 'seodaemun-1pdvsqm', name: '신촌럭키', district: '서대문구', size: '59㎡~142㎡', basePrice: 12.9, tier: '14', note: '프리미엄콘텐츠+사용자이미지 | 최근 실거래 16억 / 최저 호가 12억9,000', naverComplexId: '423' },
  { id: 'seongdong-x8lqtq', name: '금호삼성래미안', district: '성동구', size: '미정', basePrice: 15.9, tier: '16', note: '저평가추천 | 16억대 강력 추천', naverComplexId: '3417' },
  { id: 'seongdong-1k5rty7', name: '서울숲행당푸르지오', district: '성동구', size: '미정', basePrice: 16, tier: '16', note: '투자분석가이드 | 행당 생활권 + 성동 인기축', naverComplexId: '27044' },
  { id: 'seongdong-kwjyik', name: '청계현대', district: '성동구', size: '미정', basePrice: 13, tier: '14', note: '프리미엄콘텐츠 | 33평 10.5억 -> 13.5억 언급', naverComplexId: '877' },
  { id: 'seongdong-xr5i65', name: '청구강변', district: '성동구', size: '미정', basePrice: 38, tier: '50', note: '투자분석가이드 | 강남 접근성 최상위권', naverComplexId: '559' },
  { id: 'seongdong-t7sq92', name: '텐즈힐1단지', district: '성동구', size: '미정', basePrice: 19.2, tier: '20', note: '투자분석가이드 | 왕십리뉴타운 핵심 + 직주근접', naverComplexId: '107240' },
  { id: 'seongbuk-bkzp2a', name: '길음센트레빌', district: '성북구', size: '미정', basePrice: 10.1, tier: '12', note: '프리미엄콘텐츠 | 24평 / 33평', naverComplexId: '3421' },
  { id: 'seongbuk-1knrei4', name: '래미안장위퍼스트하이', district: '성북구', size: '59㎡~144㎡', basePrice: 12, tier: '12', note: '사용자이미지 | 최근 실거래 14억4,000 / 최저 호가 12억', naverComplexId: '113985' },
  { id: 'seongbuk-zsscd0', name: '삼선푸르지오', district: '성북구', size: '40평', basePrice: 9.2, tier: '12', note: '사용자이미지 | 매매 실거래 10억8,500 / 3개월 20건', naverComplexId: '22158' },
  { id: 'seongbuk-y2ehen', name: '장위코오롱하늘채', district: '성북구', size: '미정', basePrice: 10.9, tier: '12', note: '프리미엄콘텐츠 | 장위뉴타운 연계', naverComplexId: '110300' },
  { id: 'songpa-xmemzf', name: 'e편한세상송파파크센트럴', district: '송파구', size: '미정', basePrice: 17.5, tier: '20', note: '투자분석가이드 | 거여·마천 재정비촉진지구 수혜', naverComplexId: '119875' },
  { id: 'songpa-1c8sv7v', name: '송파위례24단지꿈에그린', district: '송파구', size: '미정', basePrice: 16, tier: '16', note: '투자분석가이드 | 위례선 트램 수혜 + 1810세대', naverComplexId: '104126' },
  { id: 'songpa-1tg22z4', name: '잠실동현대', district: '송파구', size: '미정', basePrice: 18.2, tier: '20', note: '투자분석가이드 | 리모델링 추진 + 잠실 접근', naverComplexId: '640' },
  { id: 'yeongdeungpo-1l2m5zx', name: '래미안당산1차', district: '영등포구', size: '미정', basePrice: 15, tier: '16', note: '투자분석가이드 | 당산·여의도 접근', naverComplexId: '676' },
  { id: 'yeongdeungpo-1ben2r4', name: '문래동현대1차', district: '영등포구', size: '미정', basePrice: 0, tier: '50', note: '투자분석가이드 | 문래 도시재생 + 직주근접', naverComplexId: '710' },
  { id: 'yongsan-1birinc', name: '강촌아파트', district: '용산구', size: '미정', basePrice: 25, tier: '28', note: '투자분석가이드 | 이촌동 한강 생활권', naverComplexId: '761' },
  { id: 'eunpyeong-et5zj9', name: '갈현1구역', district: '은평구', size: '미정', basePrice: 5.1, tier: '12', note: '뉴스레터 | 초기 투자금 5~6억대', naverComplexId: '3817' },
  { id: 'eunpyeong-1biyvnj', name: '미성아파트', district: '은평구', size: '미정', basePrice: 7.9, tier: '12', note: '뉴스레터 | 총매수금액 7~8억대', naverComplexId: '780' },
  { id: 'eunpyeong-1pz6gk1', name: '은평뉴타운박석고개힐스테이트1단지', district: '은평구', size: '미정', basePrice: 9.5, tier: '12', note: '뉴스레터 | 구파발역 준신축 9억대', naverComplexId: '26869' },
  { id: 'junggu-16xdw4p', name: '래미안신당하이베르', district: '중구', size: '미정', basePrice: 16.2, tier: '20', note: '투자분석가이드 | 도심 직주근접 + 784세대', naverComplexId: '27820' },
  { id: 'junggu-hxhcd5', name: '보문아이파크', district: '중구', size: '미정', basePrice: 10.5, tier: '12', note: '프리미엄콘텐츠 | 삼선동·보문 생활권', naverComplexId: '8841' },
